...
public class VendingMachineApp {
	...
	***************************************************************************************************************************/
		...
		public static void main(String[] args) throws IOException {
			...
			VendingMachineCLI vendingCli = new VendingMachineCLI(vendingMenu, purchaseMenu); // Instantiate the Vending Machine CLI main program passing it the Menu object to use
			vendingCli.run();    
			// Tell the Vending MachineCLI process to start running		
